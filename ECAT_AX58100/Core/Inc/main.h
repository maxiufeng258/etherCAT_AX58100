...
#define PDI_IRQ_Pin GPIO_PIN_5
#define PDI_IRQ_GPIO_Port GPIOD
#define PDI_IRQ_EXTI_IRQn EXTI9_5_IRQn
#define sync0_Pin GPIO_PIN_6
#define sync0_GPIO_Port GPIOD
#define sync0_EXTI_IRQn EXTI9_5_IRQn
#define sync1_Pin GPIO_PIN_7
